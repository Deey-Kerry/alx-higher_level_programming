...
class TestRectangle_width(unittest.TestCase):
    """Unittests for testing width of Rectangle"""
...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for testing __str__ of Rectangle class."""

    @staticmethod
    def capture_stdout(rect, method):
        """Captures and returns text printed to stdout.
        Args:
            by calling method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_args(unittest.TestCase):
    """Unittests for testing update arguements"""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """unittests for testing dictionary of the Rectangle class"""
