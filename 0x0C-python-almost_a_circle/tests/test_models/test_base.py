...
class TestBase(unittest.TestCase):
    """Tests for class models/base.py"""
    ...
    def test_id_not_given(self):
        """Test ids match not given"""
        self.assertTrue(Base(), self.id == 1)
        self.assertTrue(Base(), self.id == 2)

    def test_private_attr_access(self):
        """Test private attribute accessible"""
        with self.assertRaises(AttributeError):
            print(Base.__nb_objects)
            print(Base.nb_objects)

    """Test arguements given in module"""
    ...
    def test_empty_to_json_string(self):
        """Test empty JSON string of empty dict"""
        d3 = dict()
    ...
    def test_from_none_json_string(self):
        """Test none JSON string translates into empty dict"""
        s2 = None
    ...
    def test_create(self):
        """Test transferring attribute dict to another instance"""
