...
class TestBase(unittest.TestCase):
    ...
    """Test arguements given"""
    def test_invalid_args(self):
        """Test too many args throws an error"""
        with self.assertRaises(TypeError):
            Square(1, 2, 3, 4, 5, 6, 7)
        """Test too little args throws an error"""
        with self.assertRaises(TypeError):
            Square()
            Square(None)
    ...
    """Test class"""
    def test_class(self):
        """Test if Rectangle class is created"""
        s = Square(10)
