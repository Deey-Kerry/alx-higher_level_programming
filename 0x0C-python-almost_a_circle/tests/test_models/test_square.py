...
class TestSquare_size(unittest.TestCase):
    """unittests for testing size of the Square class."""
...
class TestSquare_x(unittest.TestCase):
    """unittests for testing Square x attribute"""
...
class TestSquare_y(unittest.TestCase):
    """unittests for testing Square y attribute"""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests for testing order of initialization"""
...
class TestSquare_area(unittest.TestCase):
    """Unittests for testing the area of the Square class"""
...
class TestSquare_stdout(unittest.TestCase):
    """unittests for testing and display methods of Square class."""

    @staticmethod
    def capture_stdout(sq, method):
        """function that Captures and returns text printed
            to stdout by calling method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestSquare_update_kwargs(unittest.TestCase):
    """unittests for update kwargs of Square class"""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittests for testing the dictionary of the Square class."""
